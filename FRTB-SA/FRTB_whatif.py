...
def main(p_data_date):
    ...
    sql="select * from TB_26_FRTB_SENSITIVITY_GROUP_WHATIF;"
    cursor.execute(sql)
    ...
    '''
    ########## result: risk factor##########
    cursor.execute("truncate table `TB_26_FRTB_SENSITIVITY_RESULT_RISKFACTOR_WHATIF`")
    db.commit()
    ...
    ########## result: bucket ##########
    cursor.execute("truncate `TB_26_FRTB_SENSITIVITY_RESULT_BUCKET_WHATIF`")
    db.commit()
    ...
    ########## result: class ##########
    cursor.execute("truncate `TB_26_FRTB_SENSITIVITY_RESULT_RISKCLASS_WHATIF`")
    db.commit()
    ...
    ########## decomp: risk factor##########
    cursor.execute("truncate `TB_26_FRTB_SENSITIVITY_DECOMP_RISKFACTOR_WHATIF`")
    db.commit()
    ...
    ########## decomp: portfolio ##########
    cursor.execute("truncate `TB_26_FRTB_SENSITIVITY_DECOMP_PORTFOLIO_WHATIF`")
    db.commit()
